            ...
            <section className='p-4 border-bottom'>
                <div className='d-flex justify-content-between align-items-center'>
                    <div className='me-lg-4 mb-3 mb-lg-0'>
                        <span style={{ color: '#666666', fontWeight: 600, fontSize: '1.2rem' }}>Get connected with us on social networks:</span>
                    </div>
                    ...
                    <MDBRow className='mt-3'>
                        ...
                        <MDBCol md="3" lg="3" xl="4" className='mb-4'>
                            ...
                            <div style={{ position: 'relative' }}> {/* Add a wrapper with relative positioning */}
                                ...
                                <motion.span
                                    style={{ whiteSpace: 'nowrap', fontSize: '1.1rem', color: '#666666', fontWeight: 600, cursor: 'pointer' }}
                                    whileHover={{ scale: 1.1 }}
                                    onClick={() => window.open('https://www.mcagulf.com', '_blank')}
                                >
                        ...
                        <MDBCol md="4" lg="4" xl="4" className='mb-4'>
                            <div>
                                ...
                                <p style={{ color: "#666666", fontWeight: 500 }}>
