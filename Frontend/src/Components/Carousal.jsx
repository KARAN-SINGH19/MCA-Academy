    ...
    return (
        <Carousel fade activeIndex={activeIndex} onSelect={handleSelect}>
            <Carousel.Item style={{ height: '600px' }} interval={4000}>
                ...
                />
                <Carousel.Caption className='crousalBox'>
                    <motion.h4 className='crousalText' variants={linkVariants} initial="hidden" animate={activeIndex === 0 ? "show" : "hidden"}>
            ...
            <Carousel.Item style={{ height: '600px' }} interval={4000}>
                ...
                <Carousel.Caption style={{
                    ...
                    <motion.h4 className='crousalText' variants={linkVariants} initial="hidden" animate={activeIndex === 1 ? "show" : "hidden"}>
            ...
            <Carousel.Item style={{ height: '600px' }} interval={4000}>
                ...
                <Carousel.Caption style={{
                    ...
                    <motion.h4 className='crousalText' variants={linkVariants} initial="hidden" animate={activeIndex === 2 ? "show" : "hidden"}>
