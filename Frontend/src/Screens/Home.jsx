...
const Home = () => {
  ...
  function PartnersSection() {
    ...
    const partners = [
      ...
      { imgSrc: '/images/isblogo.jpeg', text: 'To develops global leaders through top-ranked programs, blending advanced research with real-world expertise.', link: 'https://www.isb.edu/en.html' },
    ];
