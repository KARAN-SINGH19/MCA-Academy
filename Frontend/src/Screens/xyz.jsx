                    ...
                    <Col style={{ position: "relative" }}>
                        <div className="image-container">
                            ...
                            <div className="overlay"><h1 style={{
                                ...
                                alignItems: "center"
                            }}>xyz - Empowering for balance</h1></div>
                        </div>
                    </Col>
                </Row>
            </Container>
            <Container>
                <Row className='mt-4'>
                    <div className="mission-section py-5 text-center">
                        {/* <h1 className='mission-heading'>xyz - Empowering for balance</h1> */}
                    </div>
                                ...
                                <Col xs={12} md={6} className='mt-4' style={{ display: 'flex' }}>
                                    ...
                                    >
                                        ...
                                        <p style={{ textAlign: "justify", padding: "10px", color: "#212529", fontWeight: 600 }}>
                                            This program aims to empower women leaders to achieve balance and fulfillment across personal and professional domains. Through a holistic approach, participants will explore strategies for managing priorities, nurturing well-being, and fostering xyz in their lives, enabling them to thrive both personally and professionally.
                                        </p>
                                    </motion.div>
                                </Col>
